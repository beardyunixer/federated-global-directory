...
$a->strings["Export Channel"] = "Kanal exportieren";
$a->strings["Export your basic channel information to a file.  This acts as a backup of your connections, permissions, profile and basic data, which can be used to import your data to a new server hub, but does not contain your content."] = "";
$a->strings["Export Content"] = "Inhalt exportieren";
$a->strings["Export your channel information and recent content to a JSON backup that can be restored or imported to another server hub. This backs up all of your connections, permissions, profile data and several months of posts. This file may be VERY large.  Please be patient - it may take several minutes for this download to begin."] = "";
$a->strings["Export your posts from a given year or month:"] = "";
$a->strings["You may also export your posts and conversations for a particular year or month. Click on one of the recent years or months below."] = "";
$a->strings["Jan"] = "Jan";
$a->strings["Feb"] = "Feb";
$a->strings["Mar"] = "Mär";
$a->strings["Apr"] = "Apr";
...
$a->strings["Nov"] = "Nov";
$a->strings["Dec"] = "Dez";
$a->strings["If the export fails (possibly due to memory exhaustion on your server hub), please try again selecting a more limited date range."] = "";
$a->strings["Or adjust the date in your browser location bar to select other dates. For example the year 2013; <a href=\"%1\$s/2013\">%1\$s/2013</a> or the month September 2013; <a href=\"%1\$s/2013/9\">%1\$s/2013/9</a>"] = "";
$a->strings["Please visit"] = "Bitte besuchen Sie";
$a->strings["on another hub to import the backup files(s)."] = "";
$a->strings["We advise you to clone the channel on the new hub first and than to import the backup file(s) (from the same channel) in chronological order. Importing the backup files into another channel will certainly give permission issues."] = "";
...
$a->strings["Set big shadow size, default 15px 15px 15px"] = "Große Schattengröße festlegen, Standard 15px 15px 15px";
$a->strings["Set small shadow size, default 5px 5px 5px"] = "Kleine Schattengröße festlegen, Standard 5px 5px 5px";
$a->strings["Set shadow color, default #000"] = "Schattenfarbe festlegen, Standdard #000";
$a->strings["Set radius size, default 5px"] = "Eckenradius festlegen, Standard 5 px";
$a->strings["Set line-height for posts and comments"] = "Zeilenabstand für Beiträge und Kommentare festlegen";
$a->strings["Set background image"] = "Hintergrundbild festlegen";
$a->strings["Set background attachment"] = "Hintergrundanhang festlegen";
...
$a->strings["Set color of links - use hex"] = "Farbe für Links festlegen - Hex verwenden";
...
$a->strings["Set color of fonts - use hex"] = "Schriftfarbe festlegen - Hex verwenden";
